...
## Separate governance desk

Governance is intentionally separated from general model and product news. The app gives dedicated weight to regulation, enforcement, rights, standards, safety, ethics and institutional policy.

### 🇺🇸 US AI czar & AI Force

The dedicated watch tracks the announced US AI czar and new AI Force as their formal remit and implementation become clearer. Coverage is monitored separately from provider/product announcements.

- [White House / AI.gov](https://www.ai.gov/)
- [Reuters AI czar / AI Force watch](https://www.reuters.com/world/us/trump-says-he-will-create-ai-force-name-ai-czar-2026-09-19/)
- [FTC AI enforcement](https://www.ftc.gov/business-guidance/artificial-intelligence)
- [US Copyright Office AI](https://www.copyright.gov/ai/)

### 🇪🇺 EU AI Act / European AI Office

Implementation, enforcement, transparency, risk obligations and official European guidance.

- [European AI Office](https://digital-strategy.ec.europa.eu/en/policies/ai-office)
- [EU AI Act](https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai)

### 🌐 WAICO and international governance

- [WAICO / China MFA reference](https://www.mfa.gov.cn/eng/wjbzhd/202607/t20260717_11984747.html)
...
The registry now includes Data & Society, Future of Privacy Forum, Algorithmic Justice League, Center for AI and Digital Policy, ACM TechPolicy AI, Partnership on AI, AI Now, Ada Lovelace Institute and AlgorithmWatch, alongside standards and safety institutes.

**[→ Current governance dataset](../data/news.json)** · **[→ Governance source registry](../config/sources-extra.json)**
