...
**[→ Core provider registry](../config/providers.json)**  
**[→ Extended provider registry](../config/providers-extra.json)**  
**[→ Full generated transparency catalog](../PRIVACY-SOURCES.md)**  
**[→ Current news dataset](../data/news.json)**

---

Official social profiles are linked only when they can be identified reliably. Social posts, images and videos are not scraped or copied.
